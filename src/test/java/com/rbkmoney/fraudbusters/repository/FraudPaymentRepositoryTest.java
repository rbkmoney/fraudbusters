...
@ContextConfiguration(classes = {ClickhouseConfig.class,
        ...
        AggregationStatusGeneralRepositoryImpl.class, FraudPaymentRepository.class},
...
public class FraudPaymentRepositoryTest {
    ...
    public static FraudPayment createFraudPayment(String id) {
        return new FraudPayment()
                .setId(id)
                .setEventTime(
                        LocalDateTime.now().format(DateTimeFormatter.ofPattern(TimestampUtil.YYYY_MM_DD_HH_MM_SS))
                )
                .setComment("")
