...
@Slf4j
class PaymentTemplateValidatorHandlerTest {

    PaymentTemplateValidatorHandler paymentTemplateValidatorHandler = new PaymentTemplateValidatorHandler(
    ...
    void validateCompilationTemplateEmptyList() throws TException {
        ...
        ValidateTemplateResponse validateTemplateResponse = paymentTemplateValidatorHandler.validateCompilationTemplate(list);
