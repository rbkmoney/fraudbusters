...
public class CountAggregatorImpl implements CountAggregator<PaymentModel, PaymentCheckedField> {
    ...
    @Override
    @BasicMetric("count")
    public Integer count(PaymentCheckedField checkedField, PaymentModel fraudModel, TimeWindow timeWindow, List<PaymentCheckedField> list) {
    ...
    public Integer countSuccess(PaymentCheckedField checkedField, PaymentModel fraudModel, TimeWindow timeWindow, List<PaymentCheckedField> list) {
    ...
    public Integer countError(PaymentCheckedField checkedField, PaymentModel fraudModel, TimeWindow timeWindow, String s, List<PaymentCheckedField> list) {
