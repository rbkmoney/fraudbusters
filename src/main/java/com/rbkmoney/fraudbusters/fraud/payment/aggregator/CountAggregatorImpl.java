...
public class CountAggregatorImpl implements CountPaymentAggregator<PaymentModel, PaymentCheckedField> {
    ...
    public Integer count(PaymentCheckedField checkedField, PaymentModel paymentModel, TimeWindow timeWindow,
        ...
        return getCount(checkedField, paymentModel, timeWindow, list,
    ...
    public Integer countError(PaymentCheckedField checkedField, PaymentModel paymentModel, TimeWindow timeWindow,
        ...
        try {
            ...
            log.debug("CountAggregatorImpl field: {} value: {}  countError: {}", resolve.getName(),
    ...
    public Integer countChargeback(PaymentCheckedField paymentCheckedField, PaymentModel paymentModel,
                                   TimeWindow timeWindow, List<PaymentCheckedField> list) {
        return getCount(paymentCheckedField, paymentModel, timeWindow, list,
                chargebackRepository::countOperationByFieldWithGroupBy, false);
    }

    @Override
    @BasicMetric("countRefund")
    public Integer countRefund(PaymentCheckedField paymentCheckedField, PaymentModel paymentModel,
                               TimeWindow timeWindow, List<PaymentCheckedField> list) {
        return getCount(paymentCheckedField, paymentModel, timeWindow, list,
                refundRepository::countOperationByFieldWithGroupBy, false);
    }
