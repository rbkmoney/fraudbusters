...
public class FraudPaymentBatchPreparedStatementSetter implements BatchPreparedStatementSetter {
    ...
    public void setValues(PreparedStatement ps, int i) throws SQLException {
        ...
        ps.setString(
                l++,
                checkedPayment.getCurrency() != null ? checkedPayment.getCurrency() : ClickhouseUtilsValue.UNKNOWN
        );

        ps.setObject(l++, checkedPayment.getPaymentStatus());
        ps.setObject(
                l++,
                checkedPayment.getErrorCode() != null ? checkedPayment.getErrorCode() : ClickhouseUtilsValue.UNKNOWN
        );
        ps.setObject(
                l++,
                checkedPayment.getErrorReason() != null ? checkedPayment.getErrorReason() : ClickhouseUtilsValue.UNKNOWN
        );
