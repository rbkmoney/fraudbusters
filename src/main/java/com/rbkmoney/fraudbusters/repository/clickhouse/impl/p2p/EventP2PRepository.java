package com.rbkmoney.fraudbusters.repository.clickhouse.impl.p2p;
...
import com.rbkmoney.fraudbusters.repository.clickhouse.impl.generator.EventP2PParametersGenerator;
import com.rbkmoney.fraudbusters.repository.clickhouse.setter.EventP2PBatchPreparedStatementSetter;
...
public class EventP2PRepository implements Repository<EventP2P>, AggregationRepository {
    ...
    public Integer countOperationByField(String fieldName, Object value, Long from, Long to) {
        return aggregationGeneralRepository.countOperationByField(
                EventSource.FRAUD_EVENTS_P_TO_P.getTable(),
                fieldName,
                value,
                from,
                to
    ...
    public Long sumOperationByFieldWithGroupBy(
            ...
            Long to,
            List<FieldModel> fieldModels) {
        return aggregationGeneralRepository.sumOperationByFieldWithGroupBy(
                EventSource.FRAUD_EVENTS_P_TO_P.getTable(),
                fieldName,
                value,
                from,
    ...
    public Integer uniqCountOperation(String fieldNameBy, Object value, String fieldNameCount, Long from, Long to) {
        return aggregationGeneralRepository.uniqCountOperation(
                EventSource.FRAUD_EVENTS_P_TO_P.getTable(),
                fieldNameBy,
                value,
                fieldNameCount,
    ...
    public Integer uniqCountOperationWithGroupBy(
        ...
        return aggregationGeneralRepository.uniqCountOperationWithGroupBy(
                EventSource.FRAUD_EVENTS_P_TO_P.getTable(),
                fieldNameBy,
                value,
                fieldNameCount,
