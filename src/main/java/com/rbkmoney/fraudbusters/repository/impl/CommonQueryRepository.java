...
public class CommonQueryRepository {
    ...
    private static final String QUERY = "SELECT cardToken" +
            " FROM fraud.payment " +
            " WHERE toDateTime(?) - INTERVAL 1 YEAR < toDateTime(eventTime) and toDateTime(?) > toDateTime(eventTime)" +
            " and status='captured' " +
            " and providerId in ('108', '114', '118', '119', '121', '125', '126', '128', '130', '136', '132', '137', " +
            "'143', '139', '144', '149')" +
