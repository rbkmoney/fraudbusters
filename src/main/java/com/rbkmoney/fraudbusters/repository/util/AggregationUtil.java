...
public class AggregationUtil {
    ...
    public static StringBuilder appendGroupingFields(List<FieldModel> fieldModels, StringBuilder sql,
    ...
    public static List<Object> generateParams(Long from, Long to, List<FieldModel> fieldModels, Object value,
        ...
        return initParams(fieldModels, dateFrom, dateTo, instantFrom.getEpochSecond(), instantTo.getEpochSecond(),
